#' @templateVar MODEL_FUNCTION cra_mv
...
#' @templateVar MODEL_NAME Mean-Variance Model
#' @templateVar MODEL_CITE (Markowitz, 1952; Chung et al., n.d., PsyArXiv)
#' @templateVar MODEL_TYPE Hierarchical
#' @templateVar DATA_COLUMNS "subjID", "prob", "ambig", "reward_var", "reward_fix", "choice"
#' @templateVar PARAMETERS "rho" (risk attitude), "beta" (ambiguity attitude), "lambda" (inverse temperature)
...
#'
#' @references
#' Chung, D., Kadlec, K., Ball, S., King-Casas, B., & Chiu, P. H. (n.d.).
#'   Evidence for preference consistency across risky, ambiguous, and vague gambles.
#'   https://doi.org/10.31234/OSF.IO/M24ZX
